...
const ColumnOpen: React.FC<ColumnOpenProps> = ({ state, number, borderColor }) => {
    ...
    return (
        <div className={`flex-row-reverse flex justify-between h-[40px] gap-[80px] rounded-[16px] border-t-[2px] shadow border-[#FD7E14] bg-white pt-[8px] pr-[12px] pb-[5px] pl-[12px] overflow-x-auto`}>
