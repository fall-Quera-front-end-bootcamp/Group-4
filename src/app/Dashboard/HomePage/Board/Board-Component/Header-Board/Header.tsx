...
import ShareProject from "./Shahre-Project/ShareProject";
...
const [showShareProject,setshowShareProject]=useState(false)
    ...
    return(
        ...
        <div className='w-[95%] pr-[285px] pt-[30px] fixed header'>
            ...
            <div className=" container pt-[16px] pb-[16px] flex  justify-between items-center W-[1034px] H-[64px] ">
                ...
                <div className="w-[118px] h-[24px] gap-[5px] flex flex-row items-center justify-center ">
                    <div className=" w-[98px] h-[23px] line_effect_l ">
                        ...
                        <span onClick={()=>setshowShareProject(!showShareProject)}
                              className="cursor-pointer text-base font-medium leading-[22.55px] text-right ">اشتراک گذاری</span>
                        <span className="absolute ml-2"><FontAwesomeIcon icon={faShareNodes}/></span>


                    </div>
                </div>
                <div className={`${!showShareProject ? 'hidden' : 'visible'}`}>
                    <ShareProject/>
                </div>
            ...
            {/*-------------------container------------------------------*/}
            <div dir="rtl"
                 className=" container flex  justify-between items-center W-[1034px] H-[64px] gap-[40px] mt-2">
                {/*-----------------------input - container----------------------------*/}
                ...
                <div dir="rtl" className="w-[754px] h-[28px] gap-[16px]  flex items-center flex-row ">
                    ...
                    <div
                        className="bg-[#D0EBFF] flex  items-center rounded-[4px] pb-[4px] pt-[4px] pl-[12px] pr-[12px] w-[160px] h-[25px] ">
                        <span
                            className=" text-blue-500 leading-[16.91px] text-right text-xs ">دسته بندی شده با : وضعیت</span>
                    </div>
                    <div
                        className=" w-[198px] h-[28px] flex flex-row justify-center items-center border-solid  border-2 rounded-[8px] pt-[4px] pr-[8px] pb-[4px] pl-[8px] gap-[6px]  border-[#208D8E] cursor-pointer ">
