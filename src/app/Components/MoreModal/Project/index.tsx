...
const MoreProjectModal: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Modal
        ...
        style={customStyles}
      >
       <div className='w-[160px] h-[128px] flex flex-col justify-between items-end mb-[20px]'>
            <button className='h-[20px] flex'>
                <h1 style={ItemsStyle}>ساختن تسک جدید</h1>
                <img src={AddIcon} alt="AddIcon" />
            </button>
            <button className='h-[20px] flex'>
                <h1 style={ItemsStyle}>ویرایش نام پروژه</h1>
...
export default MoreProjectModal;
