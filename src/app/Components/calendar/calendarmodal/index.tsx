  ...
  return (
    <div style={{ width:'936px',height:'632px'}}>
        <header style={{direction:'rtl', display:'flex', justifyContent:"flex-start",alignItems:'center', height:'100px'}}>
            <p style={{width:'438px', margin:'20px',fontSize:'24px'}}>زمان شروع <span style={{marginRight:'10px' ,color:'#208D8E'}}>{startDate? startDate.format('jD jMMMM '):''}</span></p>
            <p style={{width:'438px', margin:'20px',fontSize:'24px'}}>زمان پایان<span style={{marginRight:'10px', color:'#208D8E'}}>{endDate?endDate.format('jD jMMMM '):''}</span></p>
        </header>
