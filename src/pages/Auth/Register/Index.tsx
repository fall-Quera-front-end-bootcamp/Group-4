        ...
        <div>
            <Form style={customStyle}>
                ...
                <div className="w-[592px] h-[355px] flex flex-col justify-center items-center pt-8">
                    ...
                    <div className="w-full flex justify-end py-4">
                        ...
                        <Link to="#"  className="w-[190px] h-[23px] size-[16px] leading-[22.55px] text-right font-medium text-black hover:t pr-1"
                              style={register}
                              onClick={toggleModal}>
                            <span className="underline underline-offset-4 hover:text-grey-700">قوانین و مقررات </span>
                            را میپذیرم
                        </Link>
            ...
            <Modal isOpen={isModalOpen} onClose={toggleModal}>
                <div>
                    ...
                    <p style={rule}>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد.
                        ...
                        در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و 
